  ...
  return (
    <section className="py-12 lg:py-32">
      <div className="container grid gap-8 px-4 md:px-6 lg:grid-cols-3">
        <div className="absolute top-0 right-0 mt-4 ml-4">
          <Image
              alt="Logo"
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <Link className="text-lg font-medium text-blue-600 hover:underline dark:text-blue-400"
                href="http://register-postman.itgeeks.social/">
          ...
          <Link className="text-lg font-medium dark:text-[#495057] hover:underline"
                href="http://register-postman.itgeeks.social/">
            http://register-postman.itgeeks.social
          </Link>
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <Link className="text-lg font-medium text-blue-600 hover:underline dark:text-blue-400"
                href="http://www.postman.com/downloads/">
            Install postman
          </Link>
          <p className="text-gray-500 dark:text-gray-400">
        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <Link className="text-lg font-medium text-blue-600 hover:underline dark:text-blue-400"
                href="http://forms.gle/DjJRqKNGEXTyQiSw6">
          ...
          <Link className="text-lg font-medium dark:text-[#495057] hover:underline"
                href="http://registre-event.itgeeks.social">
            http://registre-event.itgeeks.social
          </Link>
        </div>
      </div>
    </section>
